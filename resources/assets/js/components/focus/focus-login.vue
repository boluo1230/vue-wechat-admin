<template>
  <div id="app">
    <el-row>
      <el-col :span="24">
        <div class="app-search-bg">
          <el-button-group>
            <el-button type="primary" icon="plus" @click="uploadFocusLoginDialog = true">添加登录广告图</el-button>
    ...
    <el-dialog title="焦点图上传" :visible.sync="uploadFocusLoginDialog">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="uploadFocusLoginDialog = false">取 消</el-button>
        <el-button type="primary" @click="uploadFocusLoginDialog = false">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
